            ...
            <SettingsLayout>
                <div className="space-y-6">
                    <HeadingSmall
                        ...
                        description="Gérez le nom, le logo, la couleur, les coordonnées et l'identité de votre application."
                    />
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="grid gap-2">
                            ...
                            {settings.logo_path && (
                                <img src={`/storage/${settings.logo_path}`} alt="Logo actuel" className="w-28 mt-3 border rounded" />
                            )}
                        </div>
                        <div className="grid gap-2">
                            <Label htmlFor="logo_dark">Logo dark mode (optionnel)</Label>
                            <Input
                                id="logo_dark"
                                type="file"
                                accept="image/*"
                            ...
                            {settings.logo_dark_path && (
                                <img src={`/storage/${settings.logo_dark_path}`} alt="Logo dark" className="w-28 mt-3 border rounded bg-neutral-900" />
                            )}
                        </div>
                        <div className="grid gap-2">
                            <Label htmlFor="favicon">Favicon (optionnel, sinon générée automatiquement)</Label>
                            <Input
                                id="favicon"
                                type="file"
                            ...
                            {settings.favicon_path && (
                                <img src={`/storage/${settings.favicon_path}`} alt="Favicon" className="w-10 h-10 border rounded bg-white" />
                            )}
                        </div>
                        <div className="grid gap-2">
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="cgu_url">Lien CGU</Label>
                            <Input
                                id="cgu_url"
                                value={data.cgu_url}
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="privacy_url">Lien Politique de confidentialité</Label>
                            <Input
                                id="privacy_url"
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input
                                ...
                                placeholder="ex: SaaS, gestion, Maroc, ..."
                            />
